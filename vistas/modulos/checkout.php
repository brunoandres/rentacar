...
if (empty($_SESSION['codigo'])) {
 ...
 toastr.success('En las fechas indicadas hay autos disponibles!', 'Reserva Disponible', {timeOut: 8000})
  ...
  echo "<script>
 toastr.info('Recuerde que debe abonar obligatoriamente el 15 % de su Reserva, de lo contrario se dará de baja la misma.', 'Aviso Importante :', {timeOut: 30000})
 </script>";
}
      ...
      <div class="row h-100 justify-content-center align-items-center">
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate method="post" action="confirmacion" onsubmit="return checkForm(this);">
            ...
            <hr class="mb-4">
            <input type="checkbox" name="acepta" required>Acepto los términos acerca del abono del 15 % de mi Reserva. <br>
